    ...
    <div>
      ...
      {matches.length === 0 && (
        <div className="card" style={{ textAlign: "center", padding: 40, color: "#8A92B2" }}>
          <i className="fi fi-rr-billiard" style={{ fontSize: 36, color: "#7B5CFF", display: "block", marginBottom: 10 }} />
  ...
  return (
    <div className="card" style={{
      ...
      <div style={{
        ...
        <PlayerSide name={m.player1Name} elo={m.player1Elo} winner={isP1Winner} isMe={view.side === "p1"} align="right" />
        <div style={{
        ...
        <PlayerSide name={m.player2Name} elo={m.player2Elo} winner={isP2Winner} isMe={view.side === "p2"} align="left" />
      </div>
...
function PlayerSide({ name, elo, winner, isMe, align }) {
  return (
    <div style={{ textAlign: align, color: winner ? "#fff" : "#C9D1FF" }}>
      <div style={{
        fontWeight: winner ? 700 : 500, fontSize: 15,
        display: "flex", alignItems: "center", gap: 6,
        justifyContent: align === "right" ? "flex-end" : "flex-start",
      }}>
        {winner && align === "left" && <i className="fi fi-sr-crown" style={{ color: "#FACC15", fontSize: 13 }} />}
        {name}
        {isMe && (
          <span style={{
        ...
        {winner && align === "right" && <i className="fi fi-sr-crown" style={{ color: "#FACC15", fontSize: 13 }} />}
      </div>
      <div style={{
        fontFamily: "JetBrains Mono, monospace",
        fontSize: 11, color: "#8A92B2", marginTop: 2,
      }}>
        Elo {elo}
      </div>
    </div>
